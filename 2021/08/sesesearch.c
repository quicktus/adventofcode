...
int main(int argc, char *argv[]) {
  ...
  // read the ten unique signal patterns and the four output signals in each
  // line e.g. "acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab |
  ...
  if (printf("digit 1: %3i times\ndigit 4: %3i times\ndigit 7: %3i "
             "times\ndigit 8: %3i times\n\nIn the output values, the digits 1, "
             "4, 7, and 8 appear a total of %i times.\n",
