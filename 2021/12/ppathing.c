...
static void pathfinder(int currentNode, int currentPath[MAX_NODE_COUNT], int cpidx) {
...
int main(int argc, char *argv[])
{
    ...
    if(printf("\nThere are %i paths through this cave system that visit small caves at most once.\n", pathCounter) < 0)
    {
		perror("printf");
        exit(EXIT_FAILURE);
	}
